...
class EndpointTests(TestCase):
    ...
    def test_general_ledger(self):
        self.assertEqual(repr(self.companyfile.general_ledger), (
            ...
            "       delete_journaltransaction(uid) - Delete selected transaction journal.\n"
            ...
            "        post_journaltransaction(data) - Create new transaction journal.\n"
            ...
            "    put_journaltransaction(uid, data) - Update selected transaction journal.\n"
