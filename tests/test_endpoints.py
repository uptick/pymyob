...
class EndpointTests(TestCase):
    ...
    def test_banking(self):
        ...
        self.assertEndpointReached(self.companyfile.banking.get_spendmoneytxn, {'uid': UID}, 'GET',
                                   f'/{CID}/Banking/SpendMoneyTxn/{UID}/')
        self.assertEndpointReached(self.companyfile.banking.put_spendmoneytxn, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Banking/SpendMoneyTxn/{UID}/')
        self.assertEndpointReached(self.companyfile.banking.post_spendmoneytxn, {'data': DATA}, 'POST',
                                   f'/{CID}/Banking/SpendMoneyTxn/')
        self.assertEndpointReached(self.companyfile.banking.delete_spendmoneytxn, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Banking/SpendMoneyTxn/{UID}/')
        self.assertEndpointReached(self.companyfile.banking.receivemoneytxn, {}, 'GET',
                                   f'/{CID}/Banking/ReceiveMoneyTxn/')
        self.assertEndpointReached(self.companyfile.banking.get_receivemoneytxn, {'uid': UID}, 'GET',
                                   f'/{CID}/Banking/ReceiveMoneyTxn/{UID}/')
        self.assertEndpointReached(self.companyfile.banking.put_receivemoneytxn, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Banking/ReceiveMoneyTxn/{UID}/')
        self.assertEndpointReached(self.companyfile.banking.post_receivemoneytxn, {'data': DATA}, 'POST',
                                   f'/{CID}/Banking/ReceiveMoneyTxn/')
        self.assertEndpointReached(self.companyfile.banking.delete_receivemoneytxn, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Banking/ReceiveMoneyTxn/{UID}/')
        self.assertEndpointReached(self.companyfile.banking.transfermoneytxn, {}, 'GET',
                                   f'/{CID}/Banking/TransferMoneyTxn/')
        self.assertEndpointReached(self.companyfile.banking.get_transfermoneytxn, {'uid': UID}, 'GET',
                                   f'/{CID}/Banking/TransferMoneyTxn/{UID}/')
        self.assertEndpointReached(self.companyfile.banking.put_transfermoneytxn, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Banking/TransferMoneyTxn/{UID}/')
        self.assertEndpointReached(self.companyfile.banking.post_transfermoneytxn, {'data': DATA}, 'POST',
                                   f'/{CID}/Banking/TransferMoneyTxn/')
        self.assertEndpointReached(self.companyfile.banking.delete_transfermoneytxn, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Banking/TransferMoneyTxn/{UID}/')
    ...
    def test_contacts(self):
        ...
        self.assertEndpointReached(self.companyfile.contacts.get_customer, {'uid': UID}, 'GET',
                                   f'/{CID}/Contact/Customer/{UID}/')
        self.assertEndpointReached(self.companyfile.contacts.put_customer, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Contact/Customer/{UID}/')
        self.assertEndpointReached(self.companyfile.contacts.post_customer, {'data': DATA}, 'POST',
                                   f'/{CID}/Contact/Customer/')
        self.assertEndpointReached(self.companyfile.contacts.delete_customer, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Contact/Customer/{UID}/')
        self.assertEndpointReached(self.companyfile.contacts.employee, {}, 'GET', f'/{CID}/Contact/Employee/')
        self.assertEndpointReached(self.companyfile.contacts.get_employee, {'uid': UID}, 'GET',
                                   f'/{CID}/Contact/Employee/{UID}/')
        self.assertEndpointReached(self.companyfile.contacts.put_employee, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Contact/Employee/{UID}/')
        self.assertEndpointReached(self.companyfile.contacts.post_employee, {'data': DATA}, 'POST',
                                   f'/{CID}/Contact/Employee/')
        self.assertEndpointReached(self.companyfile.contacts.delete_employee, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Contact/Employee/{UID}/')
        self.assertEndpointReached(self.companyfile.contacts.supplier, {}, 'GET', f'/{CID}/Contact/Supplier/')
        self.assertEndpointReached(self.companyfile.contacts.get_supplier, {'uid': UID}, 'GET',
                                   f'/{CID}/Contact/Supplier/{UID}/')
        self.assertEndpointReached(self.companyfile.contacts.put_supplier, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Contact/Supplier/{UID}/')
        self.assertEndpointReached(self.companyfile.contacts.post_supplier, {'data': DATA}, 'POST',
                                   f'/{CID}/Contact/Supplier/')
        self.assertEndpointReached(self.companyfile.contacts.delete_supplier, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Contact/Supplier/{UID}/')
    ...
    def test_invoices(self):
        ...
        self.assertEndpointReached(self.companyfile.invoices.get_item, {'uid': UID}, 'GET',
                                   f'/{CID}/Sale/Invoice/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.invoices.put_item, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Sale/Invoice/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.invoices.post_item, {'data': DATA}, 'POST',
                                   f'/{CID}/Sale/Invoice/Item/')
        self.assertEndpointReached(self.companyfile.invoices.delete_item, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Sale/Invoice/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.invoices.service, {}, 'GET', f'/{CID}/Sale/Invoice/Service/')
        self.assertEndpointReached(self.companyfile.invoices.get_service, {'uid': UID}, 'GET',
                                   f'/{CID}/Sale/Invoice/Service/{UID}/')
        self.assertEndpointReached(self.companyfile.invoices.put_service, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Sale/Invoice/Service/{UID}/')
        self.assertEndpointReached(self.companyfile.invoices.post_service, {'data': DATA}, 'POST',
                                   f'/{CID}/Sale/Invoice/Service/')
        self.assertEndpointReached(self.companyfile.invoices.delete_service, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Sale/Invoice/Service/{UID}/')
    ...
    def test_customer_payments(self):
        ...
        self.assertEndpointReached(self.companyfile.customer_payments.get, {'uid': UID}, 'GET',
    ...
    def test_quotes(self):
        ...
        self.assertEndpointReached(self.companyfile.quotes.get_item, {'uid': UID}, 'GET',
                                   f'/{CID}/Sale/Quote/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.quotes.put_item, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Sale/Quote/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.quotes.post_item, {'data': DATA}, 'POST',
                                   f'/{CID}/Sale/Quote/Item/')
        self.assertEndpointReached(self.companyfile.quotes.delete_item, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Sale/Quote/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.quotes.service, {}, 'GET', f'/{CID}/Sale/Quote/Service/')
        self.assertEndpointReached(self.companyfile.quotes.get_service, {'uid': UID}, 'GET',
                                   f'/{CID}/Sale/Quote/Service/{UID}/')
        self.assertEndpointReached(self.companyfile.quotes.put_service, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Sale/Quote/Service/{UID}/')
        self.assertEndpointReached(self.companyfile.quotes.post_service, {'data': DATA}, 'POST',
                                   f'/{CID}/Sale/Quote/Service/')
        self.assertEndpointReached(self.companyfile.quotes.delete_service, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Sale/Quote/Service/{UID}/')
    ...
    def test_general_ledger(self):
        ...
        self.assertEndpointReached(self.companyfile.general_ledger.get_taxcode, {'uid': UID}, 'GET',
                                   f'/{CID}/GeneralLedger/TaxCode/{UID}/')
        self.assertEndpointReached(self.companyfile.general_ledger.put_taxcode, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/GeneralLedger/TaxCode/{UID}/')
        self.assertEndpointReached(self.companyfile.general_ledger.post_taxcode, {'data': DATA}, 'POST',
                                   f'/{CID}/GeneralLedger/TaxCode/')
        self.assertEndpointReached(self.companyfile.general_ledger.delete_taxcode, {'uid': UID}, 'DELETE',
                                   f'/{CID}/GeneralLedger/TaxCode/{UID}/')
        self.assertEndpointReached(self.companyfile.general_ledger.account, {}, 'GET', f'/{CID}/GeneralLedger/Account/')
        self.assertEndpointReached(self.companyfile.general_ledger.get_account, {'uid': UID}, 'GET',
                                   f'/{CID}/GeneralLedger/Account/{UID}/')
        self.assertEndpointReached(self.companyfile.general_ledger.put_account, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/GeneralLedger/Account/{UID}/')
        self.assertEndpointReached(self.companyfile.general_ledger.post_account, {'data': DATA}, 'POST',
                                   f'/{CID}/GeneralLedger/Account/')
        self.assertEndpointReached(self.companyfile.general_ledger.delete_account, {'uid': UID}, 'DELETE',
                                   f'/{CID}/GeneralLedger/Account/{UID}/')
        self.assertEndpointReached(self.companyfile.general_ledger.category, {}, 'GET',
                                   f'/{CID}/GeneralLedger/Category/')
        self.assertEndpointReached(self.companyfile.general_ledger.get_category, {'uid': UID}, 'GET',
                                   f'/{CID}/GeneralLedger/Category/{UID}/')
        self.assertEndpointReached(self.companyfile.general_ledger.put_category, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/GeneralLedger/Category/{UID}/')
        self.assertEndpointReached(self.companyfile.general_ledger.post_category, {'data': DATA}, 'POST',
                                   f'/{CID}/GeneralLedger/Category/')
        self.assertEndpointReached(self.companyfile.general_ledger.delete_category, {'uid': UID}, 'DELETE',
                                   f'/{CID}/GeneralLedger/Category/{UID}/')
        self.assertEndpointReached(self.companyfile.general_ledger.journaltransaction, {}, 'GET',
                                   f'/{CID}/GeneralLedger/JournalTransaction/')
        self.assertEndpointReached(self.companyfile.general_ledger.accountregister, {}, 'GET',
                                   f'/{CID}/GeneralLedger/AccountRegister/')
        self.assertEndpointReached(self.companyfile.general_ledger.accountingproperties, {}, 'GET',
    ...
    def test_inventory(self):
        ...
        self.assertEndpointReached(self.companyfile.inventory.get_item, {'uid': UID}, 'GET',
                                   f'/{CID}/Inventory/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.inventory.put_item, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Inventory/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.inventory.post_item, {'data': DATA}, 'POST',
                                   f'/{CID}/Inventory/Item/')
        self.assertEndpointReached(self.companyfile.inventory.delete_item, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Inventory/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.inventory.itempricematrix, {}, 'GET',
                                   f'/{CID}/Inventory/ItemPriceMatrix/')
        self.assertEndpointReached(self.companyfile.inventory.get_itempricematrix, {'uid': UID}, 'GET',
                                   f'/{CID}/Inventory/ItemPriceMatrix/{UID}/')
        self.assertEndpointReached(self.companyfile.inventory.put_itempricematrix, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Inventory/ItemPriceMatrix/{UID}/')
        self.assertEndpointReached(self.companyfile.inventory.location, {}, 'GET', f'/{CID}/Inventory/Location/')
        self.assertEndpointReached(self.companyfile.inventory.get_location, {'uid': UID}, 'GET',
                                   f'/{CID}/Inventory/Location/{UID}/')
        self.assertEndpointReached(self.companyfile.inventory.put_location, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Inventory/Location/{UID}/')
        self.assertEndpointReached(self.companyfile.inventory.post_location, {'data': DATA}, 'POST',
                                   f'/{CID}/Inventory/Location/')
        self.assertEndpointReached(self.companyfile.inventory.delete_location, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Inventory/Location/{UID}/')
        self.assertEndpointReached(self.companyfile.inventory.adjustment, {}, 'GET', f'/{CID}/Inventory/Adjustment/')
        self.assertEndpointReached(self.companyfile.inventory.get_adjustment, {'uid': UID}, 'GET',
                                   f'/{CID}/Inventory/Adjustment/{UID}/')
        self.assertEndpointReached(self.companyfile.inventory.put_adjustment, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Inventory/Adjustment/{UID}/')
        self.assertEndpointReached(self.companyfile.inventory.post_adjustment, {'data': DATA}, 'POST',
                                   f'/{CID}/Inventory/Adjustment/')
        self.assertEndpointReached(self.companyfile.inventory.delete_adjustment, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Inventory/Adjustment/{UID}/')
    ...
    def test_purchase_orders(self):
        ...
        self.assertEndpointReached(self.companyfile.purchase_orders.get_item, {'uid': UID}, 'GET',
                                   f'/{CID}/Purchase/Order/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.purchase_orders.put_item, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Purchase/Order/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.purchase_orders.post_item, {'data': DATA}, 'POST',
                                   f'/{CID}/Purchase/Order/Item/')
        self.assertEndpointReached(self.companyfile.purchase_orders.delete_item, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Purchase/Order/Item/{UID}/')
    ...
    def test_purchase_bills(self):
        ...
        self.assertEndpointReached(self.companyfile.purchase_bills.get_item, {'uid': UID}, 'GET',
                                   f'/{CID}/Purchase/Bill/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.purchase_bills.put_item, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Purchase/Bill/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.purchase_bills.post_item, {'data': DATA}, 'POST',
                                   f'/{CID}/Purchase/Bill/Item/')
        self.assertEndpointReached(self.companyfile.purchase_bills.delete_item, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Purchase/Bill/Item/{UID}/')
        self.assertEndpointReached(self.companyfile.purchase_bills.service, {}, 'GET', f'/{CID}/Purchase/Bill/Service/')
        self.assertEndpointReached(self.companyfile.purchase_bills.get_service, {'uid': UID}, 'GET',
                                   f'/{CID}/Purchase/Bill/Service/{UID}/')
        self.assertEndpointReached(self.companyfile.purchase_bills.put_service, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Purchase/Bill/Service/{UID}/')
        self.assertEndpointReached(self.companyfile.purchase_bills.post_service, {'data': DATA}, 'POST',
                                   f'/{CID}/Purchase/Bill/Service/')
        self.assertEndpointReached(self.companyfile.purchase_bills.delete_service, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Purchase/Bill/Service/{UID}/')
        self.assertEndpointReached(self.companyfile.purchase_bills.miscellaneous, {}, 'GET',
                                   f'/{CID}/Purchase/Bill/Miscellaneous/')
        self.assertEndpointReached(self.companyfile.purchase_bills.get_miscellaneous, {'uid': UID}, 'GET',
                                   f'/{CID}/Purchase/Bill/Miscellaneous/{UID}/')
        self.assertEndpointReached(self.companyfile.purchase_bills.put_miscellaneous, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Purchase/Bill/Miscellaneous/{UID}/')
        self.assertEndpointReached(self.companyfile.purchase_bills.post_miscellaneous, {'data': DATA}, 'POST',
                                   f'/{CID}/Purchase/Bill/Miscellaneous/')
        self.assertEndpointReached(self.companyfile.purchase_bills.delete_miscellaneous, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Purchase/Bill/Miscellaneous/{UID}/')

    def test_supplier_payments(self):
        self.assertEqual(repr(self.companyfile.supplier_payments), (
        ...
        self.assertEndpointReached(self.companyfile.supplier_payments.all, {}, 'GET',
                                   f'/{CID}/Purchase/SupplierPayment/')
        self.assertEndpointReached(self.companyfile.supplier_payments.get, {'uid': UID}, 'GET',
                                   f'/{CID}/Purchase/SupplierPayment/{UID}/')
        self.assertEndpointReached(self.companyfile.supplier_payments.put, {'uid': UID, 'data': DATA}, 'PUT',
                                   f'/{CID}/Purchase/SupplierPayment/{UID}/')
        self.assertEndpointReached(self.companyfile.supplier_payments.delete, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Purchase/SupplierPayment/{UID}/')
        self.assertEndpointReached(self.companyfile.supplier_payments.post, {'data': DATA}, 'POST',
                                   f'/{CID}/Purchase/SupplierPayment/')

    def test_debit_refunds(self):
        self.assertEqual(repr(self.companyfile.debit_refunds), (
        ...
        self.assertEndpointReached(self.companyfile.debit_refunds.all, {}, 'GET', f'/{CID}/Purchase/DebitRefund/')
        self.assertEndpointReached(self.companyfile.debit_refunds.get, {'uid': UID}, 'GET',
                                   f'/{CID}/Purchase/DebitRefund/{UID}/')
        self.assertEndpointReached(self.companyfile.debit_refunds.delete, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Purchase/DebitRefund/{UID}/')
        self.assertEndpointReached(self.companyfile.debit_refunds.post, {'data': DATA}, 'POST',
                                   f'/{CID}/Purchase/DebitRefund/')

    def test_debit_settlements(self):
        self.assertEqual(repr(self.companyfile.debit_settlements), (
        ...
        self.assertEndpointReached(self.companyfile.debit_settlements.all, {}, 'GET',
                                   f'/{CID}/Purchase/DebitSettlement/')
        self.assertEndpointReached(self.companyfile.debit_settlements.get, {'uid': UID}, 'GET',
                                   f'/{CID}/Purchase/DebitSettlement/{UID}/')
        self.assertEndpointReached(self.companyfile.debit_settlements.delete, {'uid': UID}, 'DELETE',
                                   f'/{CID}/Purchase/DebitSettlement/{UID}/')
        self.assertEndpointReached(self.companyfile.debit_settlements.post, {'data': DATA}, 'POST',
                                   f'/{CID}/Purchase/DebitSettlement/')
